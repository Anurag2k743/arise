...
export default function Header() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            if (window.innerWidth < 1024) {
                ...
                // Desktop: visible only after scroll
    ...
    return (
        <header
            className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 md:py-2
            ${isScrolled ? "bg-[#0C1027] shadow-md shadow-[#1A1F4C]/50" : "bg-transparent"}`}
        >
            <div className="header_container">
                ...
                {/* Mobile Menu */}
                <div
                    className={`lg:hidden px-6 transition-all duration-300 ease-in-out overflow-hidden ${mobileMenuOpen
